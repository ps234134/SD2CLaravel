            ...
            <div class="container" data-aos="zoom-in" data-aos-delay="100">
                ...
                <div class="row hero-main">
                    <div class="col d-flex  align-items-center justify-content-center">
                        <h1 style="letter-spacing: 3px; font-weight: 400;">Hello, my name is Tutai Tran <br><br>welcome to: <span class="typed" data-typed-items="MENTOR 1"></span></h1>
                    </div>
        ...
        <div id="opdr2">
            <div class="container reveal">
                <div class="about-main">
                    ...
                    <div class="row about-row d-flex">
                        <div class="col-md-4">
                            <img src="assets/img/opdr2/2-1.png" alt="2-1">
                        </div>
                        <div class="col-md-4">
                            <img src="assets/img/opdr2/2-2.png" alt="2-2">
                        </div>
                        <div class="col-md-4 d-flex justify-content-center">
                            <img src="assets/img/opdr2/2-3.png" alt="2-3">
                        </div>
                    </div>
                </div>
            </div>
