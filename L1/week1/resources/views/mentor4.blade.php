            ...
            <div class="container" data-aos="zoom-in" data-aos-delay="100">
                <div class="row hero-main">
                    <div class="col d-flex  align-items-center justify-content-center">
                        <h1 style="letter-spacing: 3px; font-weight: 400;">Hello, my name is Tutai Tran <br><br>welcome to: <span class="typed" data-typed-items="MENTOR 4"></span></h1>
                    </div>
